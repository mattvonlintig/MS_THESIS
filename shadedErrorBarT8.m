function H=shadedErrorBarT8(x,y,errBar,tau,lineProps,transparent)
...
% Paint Color Patch
H.patch = patch('Faces', face, 'facealpha', faceAlpha, 'Vertices', vert1, 'FaceVertexCData', cT8,...
    'FaceColor', 'interp', 'EdgeColor', 'none'); hold on;
patch('Faces', face, 'facealpha', faceAlpha, 'Vertices', vert2, 'FaceVertexCData', cT8,...
    'FaceColor', 'interp', 'EdgeColor', 'none'); colormap(cT8map);alpha(.55)
